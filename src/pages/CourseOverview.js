...
export default function CourseOverview() {
     ...
     const [tookCourse, setTookCourse] = useState('');
          ...
          const fetchData = async () => {
               try {
                    ...
                    try {
                         ...
                         // console.log(id, storedUserId, currentCourseId);
     ...
     // ------------THIS IS THE HANDLECLICK EVENTS------------//
     ...
     return (
          <>
                         ...
                         <Box>
                              ...
                              <Box sx={{ margin: '50px 0px' }}>
                                   {takenCourse === true ? <Button variant="contained" startIcon={<Iconify icon="line-md:confirm" />} onClick={(event) => handleClick(event, id)}>
                                        resume
                                   </Button> : <Button variant="contained" startIcon={<Iconify icon="line-md:confirm" />} onClick={(event) => handleClick(event, id)} disabled={!tookCourse}>
                                        Get Started
                                   </Button>}
                                   &nbsp;
                                   {transcriptEdit ?
               ...
               {transcriptEdit ? (<CourseEditPage />) : addExam ? (<AddQuizPage />) : (
                    <Container maxWidth="xl">
                         <Grid container spacing={3}>
                                        ...
                                        <Box className='item flexSB' sx={{ py: 2, px: 2 }}>
                                             ...
                                             <List sx={{ display: 'inline-flex', width: '100%', bgcolor: 'background.paper' }}>
                                                  ...
                                                  <ListItem>
                                                       ...
                                                       <ListItemText primary="Subtitles" secondary="Subtitles: Visaya, Tagalog, + 100 more" />
                                                  </ListItem>
                                             </List>
                                        </Box>
                                   </Card>
                              ...
                              <Grid item xs={12} md={6} lg={8}>
                                   <Card>
                                        ...
                                        <Box className='item' sx={{ pt: 0, px: 2 }}>
